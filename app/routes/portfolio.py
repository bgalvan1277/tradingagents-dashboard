"""Portfolio route: watchlist tickers with latest run status."""
...
async def portfolio(request: Request, db: AsyncSession = Depends(get_db)):
    """Show the portfolio with latest run per watchlist ticker."""
